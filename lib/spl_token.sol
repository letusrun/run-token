...
library SplToken {
    ...
    address constant associatedTokenProgramId =
        address"ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL";
    address constant rentAddress =
    ...
    function create_associated_token_account(
        ...
        AccountMeta[6] metas = [
            ...
            AccountMeta({pubkey: mint, is_writable: false, is_signer: false}),
            AccountMeta({
                pubkey: SystemInstruction.systemAddress,
                is_writable: false,
                is_signer: false
            }),
            AccountMeta({
                pubkey: SplToken.tokenProgramId,
                is_writable: false,
                is_signer: false
            })
        ];
    ...
    function transfer(address from, address to, address owner, uint64 amount)
        internal
    {
        bytes instr = new bytes(9);
    ...
    function get_account_info(address account)
        internal
        view
        returns (AccountInfo)
    {
    ...
    function get_token_account_data(address tokenAccount)
        public
        view
        returns (TokenAccountData)
    {
    ...
    function get_mint_account_data(address mintAccount)
        public
        view
        returns (MintAccountData)
    {

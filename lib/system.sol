...
library SystemInstruction {
    ...
    function create_account(
        ...
        bytes bincode = abi.encode(
            uint32(Instruction.CreateAccount), lamports, space, owner
        );
    ...
    function create_nonce_account_with_seed(
        ...
        create_account_with_seed(
            from, nonce, base, seed, lamports, state_size, systemAddress
        );
        ...
        bytes bincode =
            abi.encode(uint32(Instruction.InitializeNonceAccount), authority);
        systemAddress.call{accounts: metas}(bincode);
    }
    ...
    function withdraw_nonce_account(
        ...
        bytes bincode =
            abi.encode(uint32(Instruction.WithdrawNonceAccount), lamports);
        systemAddress.call{accounts: metas}(bincode);
    }
    ...
    function authorize_nonce_account(
        ...
        bytes bincode =
            abi.encode(uint32(Instruction.AuthorizeNonceAccount), new_authority);
        systemAddress.call{accounts: metas}(bincode);
    }
